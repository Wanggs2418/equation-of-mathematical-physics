...
\usepackage[framed,numbered,autolinebreaks,useliterate]{mcode}%使用matlab语言样式
\usepackage{mathtools}%使用displaystyle形式的cases公式-dcases
\usepackage{paralist}%列表环境的扩展，支持行间公式
